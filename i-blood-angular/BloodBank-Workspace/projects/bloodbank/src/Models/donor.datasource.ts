...
export class DataSource {
  ...
  savedonor(donor: donor_form): Observable<donor_form> {
    return this.http.post<donor_form>(`http://13.48.82.196:8304/details/save`, donor);
  }
  getDonorAll(): Observable<donor_form[]> {
    return this.http.get<donor_form[]>('http://13.48.82.196:8304/details/all');
  }

  deleteDetails(id: number): Observable<donor_form[]> {
    return this.http.get<donor_form[]>(`http://13.48.82.196:8304/details/delete/${id}`);
  }
  ...
  updateDonorForm(donorDetails: donor_form): Observable<donor_form> {
    return this.http.put<donor_form>('http://13.48.82.196:8304/details/update', donorDetails);
  }
  ...
  statusAccept(status: donor_form): Observable<donor_form> {
    return this.http.put<donor_form>('http://13.48.82.196:8304/details/status/accepted', status);
  }

  statusReject(status: donor_form): Observable<donor_form> {
    return this.http.put<donor_form>('http://13.48.82.196:8304/details/status/rejected', status);
  }
