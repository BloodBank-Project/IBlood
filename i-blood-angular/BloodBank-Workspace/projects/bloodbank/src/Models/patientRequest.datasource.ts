...
export class DataSource {
  ...
  getPatientRequest(): Observable<PatientRequest[]> {
    return this.http.get<PatientRequest[]>(`http://13.48.82.196:8305/patientRequest/allPatients`);
  }
  savePatientRequest(PatientRequest: PatientRequest): Observable<PatientRequest> {
    return this.http.post<PatientRequest>(`http://13.48.82.196:8305/patientRequest/save`, PatientRequest);
  }
  deletePatient(requestId: number) {
    return this.http.delete(`http://13.48.82.196:8305/patientRequest/${requestId}`)
  }
  ...
  updatePatientForm(patientRequest: PatientRequest): Observable<PatientRequest> {
    return this.http.put<PatientRequest>('http://13.48.82.196:8305/patientRequest/update', patientRequest);
  }
  ...
  statusAccept(status: PatientRequest): Observable<PatientRequest> {
    return this.http.put<PatientRequest>('http://13.48.82.196:8305/patientRequest/status/accepted', status);
  }

  statusReject(status: PatientRequest): Observable<PatientRequest> {
    return this.http.put<PatientRequest>('http://13.48.82.196:8305/patientRequest/status/rejected', status);
  }
